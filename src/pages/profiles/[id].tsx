...
export async function getServerSideProps(context: GetServerSidePropsContext) {
    ...
    try {
        ...
        const { data, error, status } = await supabase.from('profiles').select().eq('user_id', id).single();
                                    ...
                                    <div className="row align-items-center">
                                        ...
                                        <div className="col-lg-9 px-xl-10">
                                            ...
                                            <div className="d-flex flex-column">
                                                ...
                                                <div className="mb-2 mb-xl-3 "><span className="h5 me-2">Twitter:</span><a className='text-danger text-decoration-none' target="_blank" href={`https://www.twitter.com/${data.twitter_username}`}>@{data.twitch_username}</a></div>
